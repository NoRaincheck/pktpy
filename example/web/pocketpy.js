...
function findWasmBinary() {
  return locateFile("pocketpy.wasm");
}
  ...
  websocket_sock_ops: {
    ...
    ioctl(sock, request, arg) {
      switch (request) {
        ...
        case 21537:
          var on = HEAP32[arg >> 2];
          if (on) sock.stream.flags |= 2048;
          else sock.stream.flags &= ~2048;
          return 0;
        default:
          return 28;
      }
    ...
    bind(sock, addr, port) {
      if (
        typeof sock.saddr != "undefined" || typeof sock.sport != "undefined"
    ...
    connect(sock, addr, port) {
      ...
      if (
        typeof sock.daddr != "undefined" && typeof sock.dport != "undefined"
      ) {
...
var inetPton6 = (str) => {
  ...
  if (str.indexOf(".") > 0) {
    ...
    words = str.split(":");
    words[words.length - 4] = Number(words[words.length - 4]) +
      Number(words[words.length - 3]) * 256;
    words[words.length - 3] = Number(words[words.length - 2]) +
...
function assignWasmExports(wasmExports) {
  _py_printexc = Module["_py_printexc"] = wasmExports["v"];
  _py_clearexc = Module["_py_clearexc"] = wasmExports["w"];
  _py_exec = Module["_py_exec"] = wasmExports["x"];
  _py_initialize = Module["_py_initialize"] = wasmExports["y"];
  _py_finalize = Module["_py_finalize"] = wasmExports["z"];
  _htons = wasmExports["A"];
  _ntohs = wasmExports["B"];
  __emscripten_stack_restore = wasmExports["C"];
  __emscripten_stack_alloc = wasmExports["D"];
  _emscripten_stack_get_current = wasmExports["E"];
  memory = wasmMemory = wasmExports["t"];
